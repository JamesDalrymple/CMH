...
### create bmi data ###
bmihh_sheet <- createSheet(wb, sheetName="bmi_hh")
addDataFrame(x=analyze$bmi_dt, sheet=bmihh_sheet, showNA=FALSE,
            row.names = FALSE, startRow=1, startColumn=1, colnamesStyle=cs3)
wn_sheet <- createSheet(wb, sheetName="wn")
addDataFrame(x=modify$wellness, sheet=wn_sheet, showNA=FALSE,
             row.names = FALSE, startRow=1, startColumn=1, colnamesStyle=cs3)

output_sheet <- createSheet(wb, sheetName="ouput_raw")
addDataFrame(x=copy(sql$output), sheet=output_sheet, showNA=FALSE,
             row.names = FALSE, startRow=1, startColumn=1, colnamesStyle=cs3)
wellness_sheet <- createSheet(wb, sheetName="wn_raw")
addDataFrame(x=copy(sql$wellness), sheet=wellness_sheet, showNA=FALSE,
             row.names = FALSE, startRow=1, startColumn=1, colnamesStyle=cs3)
